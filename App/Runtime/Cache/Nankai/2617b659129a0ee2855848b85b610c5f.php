        ...
        <div class="box-main fl">
         ...
         <div style="padding-top:15px; border-top:1px solid #ccc;">
          <div class="fl" style="color:#468847;">
            <?php if($preArticle != null): ?>前一个：<a href="<?php echo U('Nankai/Article/index',array('articleid'=>$preArticle['article_id']));?>" ><span><?php echo ($preArticle["title"]); ?></span></a>
            <?php else: ?>
               没有了<?php endif; ?>
          </div>
          <div class="fr" style="color:#468847;" >
            <?php if($nextArticle != null): ?>下一个：<a href="<?php echo U('Nankai/Article/index',array('articleid'=>$nextArticle['article_id']));?>" ><span><?php echo ($nextArticle["title"]); ?></span></a>
            <?php else: ?>
               没有了<?php endif; ?>
          </div>
        </div>
