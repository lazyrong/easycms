...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a  target="selectedTodo" target="dialog" rel="ids[]" href="__URL__/recAll/navTabId/listarticle1" class="add" ><span>批量恢复文章</span></a></li>
			<li class="line">line</li>
			<li><a  target="selectedTodo" target="dialog" rel="ids[]" href="__URL__/delAll/navTabId/listarticle1" class="delete" ><span>批量永久删除</span></a></li>
