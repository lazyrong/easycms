...
<!-- 					<div class="accordionHeader">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							...
							<li><a href="#" target="navTab" rel="listbanner2" title="项目推荐" >项目推荐</a></li>
							<li><a href="#" target="navTab" rel="listbanner3" title="投资机构推荐" >投资机构推荐</a></li>
							<li><a href="#" target="navTab" rel="listbanner4" title="合作媒体展示" >合作媒体展示</a></li>
						</ul>
					</div>
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="<?php echo U('Admin/articlem/index',array('catsid'=>71));?>" target="navTab" rel="listcate71" title="南开好项目" >南开好项目管理</a></li>
							<li><a href="<?php echo U('Admin/articlem/index',array('catsid'=>72));?>" target="navTab" rel="listcate72" title="私董会" >私董会管理</a></li>
							<li><a href="<?php echo U('Admin/articlem/index',array('catsid'=>73));?>" target="navTab" rel="listcate73" title="机构" >机构管理</a></li>
							<li><a href="<?php echo U('Admin/articlem/index',array('catsid'=>74));?>" target="navTab" rel="listcate74" title="创投学院" >创投学院管理</a></li>
							<li><a href="<?php echo U('Admin/articlem/index',array('catsid'=>75));?>" target="navTab" rel="listcate75" title="赛区" >赛区管理</a></li>
							<li><a href="<?php echo U('Admin/articlem/index',array('catsid'=>86));?>" target="navTab" rel="listcate86" title="关于我们" >关于我们管理</a></li>
