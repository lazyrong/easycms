  ...
  <div class="col-lg-8 col-md-8 content">
    <div id="carousel-example-generic" class="carousel slide mb20" data-ride="carousel"> 
      ...
      <div class="carousel-inner">
        <?php if(is_array($modelid1)): $i = 0; $__LIST__ = array_slice($modelid1,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$images0): $mod = ($i % 2 );++$i;?><div class="item active">
          <a href="<?php echo U('Index/Article/index/',array('articleid'=>$images0['article_id']));?>" target="_blank"><img  style="margin:0 auto;max-height:300px;" src="<?php echo (imgs($images0["content"],$images0.content)); ?>" alt="<?php echo ($images0["title"]); ?>" /></a>
          <div class="carousel-caption"> </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
        <?php if(is_array($modelid1)): $i = 0; $__LIST__ = array_slice($modelid1,1,2,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$images): $mod = ($i % 2 );++$i;?><div class="item"> <a href="<?php echo U('Index/Article/index/',array('articleid'=>$images['article_id']));?>" target="_blank"><img style="margin:0 auto;max-height:300px;" src="<?php echo (imgs($images["content"],$images.content)); ?>" alt="<?php echo ($images["title"]); ?>" /></a>
          <div class="carousel-caption"> </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
      </div>
      <!-- Controls --> 
   ...
   <div class="media mb20"> <a class="pull-left" href="l"> <img class="media-object" alt="<?php echo R('Siteinfo/info',array('title'),'Widget');?>" src="../Public/Images/logo1.png"> </a>
      <div class="media-body">
        <h4 class="media-heading"><a href="" target="_blank"><?php echo R('Siteinfo/info',array('title'),'Widget');?></a></h4>
        <?php echo R('Siteinfo/info',array('description'),'Widget');?> </div>
    </div>
        ...
        <div class="thumbnail">
          ...
          <div class="caption">
            <div class="stickyContent">
              <h3 class="stickyTitle"><a href="<?php echo U('Index/Article/index/',array('articleid'=>$modelid1['article_id']));?>" title="<?php echo ($modelid1["title"]); ?>"><span itemprop="itemListElement"><?php echo ($modelid1["title"]); ?></span></a></h3>
            ...
            <a itemprop="url" href="<?php echo U('Index/Article/index/',array('articleid'=>$modelid1['article_id']));?>" class="btn btn-primary" role="button" target="_blank">阅读全文</a> </div>
        </div>
      </div><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
...
<?php if(is_array($modelid0)): $i = 0; $__LIST__ = $modelid0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$modelids): $mod = ($i % 2 );++$i;?><div class="col-lg-6 col-md-6 col-sm-6 mb20 indexCat" itemscope itemtype="">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title" itemprop="name"><a href="<?php echo U('Index/List/index',array('catsid'=>$modelids['id']));?>"><?php echo ($modelids["name"]); ?></a></h3>
        </div>
       <ul class="list-group">
       <?php if(is_array($modelids["Article"])): $i = 0; $__LIST__ = $modelids["Article"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Articles): $mod = ($i % 2 );++$i; if($Articles["ispush"] == 1): ?><a itemprop="url" href="<?php echo U('Index/Article/index/',array('articleid'=>$Articles['article_id']));?>"class="list-group-item">
